...
4. Enter these Render environment variables:
   ...
   | FAL_IMAGE_MODEL | fal-ai/flux-2/edit |
...
6. On iPhone, open https://nbiryukov25.github.io/joyce-photos-gallery/portrait.html → **ANGLE PACK**. Sign in. First leave **Generation mode = MOCK**, generate one image, regenerate it, and download the PNG. Then select **LIVE**, **Generative Angle**, **1 output**, an angle and framing, and explicitly press **GENERATE 1 IMAGE** for your first paid test.
